...
class Client(object):
    def __init__(self,H=None,p=None,i=None,e=None,t=None,s=None,d=None,vision=False):
        ...
        self.debug= False
        self.maxSteps= 1  # 50steps/second #100000
            ...
            try:
                ...
                if n_fail < 0:
                    ...
                    if self.vision is False:
                        os.system('start wtorcs.exe -nofuel -nolaptime')
                    else:
                        os.system('start wtorcs.exe -nofuel -nolaptime -vision')
                    time.sleep(10.0)
                    os.system('powershell -executionpolicy bypass -File autostart.ps1')
                    n_fail = 5
                n_fail -= 1
        ...
        for k in sensors:
            if type(self.d.get(k)) is list: # Handle list type data.
                ...
                if k == u'gear': # This is redundant now since it's part of RPM.
                    ...
                    if self.d[k]:
                        strout= u'%3d %s' % (self.d[k], bargraph(self.d[k],0,300,50,"'"))
